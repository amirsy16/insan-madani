                ...
                Filter::make('donasis_count')
                    ...
                    ->query(function (Builder $query, array $data): Builder {
                        return $query
                            ...
                            ->when(
                                $data['min'] ?? null,
                                fn (Builder $query, $min): Builder => $query->having('donasis_count', '>=', $min),
                            )
                            ->when(
                                $data['max'] ?? null,
                                fn (Builder $query, $max): Builder => $query->having('donasis_count', '<=', $max),
                            );
                    }),
